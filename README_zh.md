# EZ Translate Lite: 智能浏览器翻译插件

[View English Version (查看英文版本)](README.md)

EZ Translate Lite 是一款现代化的浏览器翻译插件，它利用大型语言模型（LLM）的强大能力，为您提供更加精准、流畅且贴近上下文的网页翻译体验。
...
- 前往 GitHub Releases 下载最新压缩包：[:link: 最新版本](https://github.com/Abelliuxl/ez-translate-lite/releases/latest)
- 解压下载的 `.zip` 文件
...
EZ Translate Lite 现在支持 **OpenRouter**，这是一个统一的 API 平台，提供来自不同提供商的数百个 AI 模型的访问：
...
EZ Translate Lite 提供多种便捷的网页文本翻译方式：
...
看看 EZ Translate Lite 与其他翻译工具在准确性和流畅性方面的对比：

### 英文到中文翻译示例

| 原文 | Google 翻译 | EZ Translate Lite |
|------|-------------|---------------|
...
* **上下文理解**: EZ Translate Lite 比传统机器翻译更好地理解上下文
